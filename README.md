...
<p align="center">
  <a href="https://github.com/CHANTXU64/MoviePilot-TV/releases"><img src="https://img.shields.io/badge/Release-v0.3.0-blue?style=flat-square" alt="release"></a>
  <a href="https://github.com/jxxghp/MoviePilot"><img src="https://img.shields.io/badge/MoviePilot-v2.10.10-darkviolet?style=flat-square" alt="MoviePilot Backend Version"></a>
...
- **后端版本**: 当前测试兼容的 MoviePilot 版本限定为：`v2.10.10`。由于 API 可能发生破坏性变更，其他版本后端可能出现功能异常或闪退。
