...
<p align="center">
  <a href="https://github.com/CHANTXU64/MoviePilot-TV/releases"><img src="https://img.shields.io/badge/Release-v0.3.5-blue?style=flat-square" alt="release"></a>
  <a href="https://github.com/jxxghp/MoviePilot"><img src="https://img.shields.io/badge/MoviePilot-v2.15.1-darkviolet?style=flat-square" alt="MoviePilot Backend Version"></a>
...
- **MoviePilot 版本**: 当前测试兼容的后端版本为 `v2.15.1`，媒体业务按 MoviePilot Web `v2.15.1` 对齐。低于该版本不在兼容范围；App 启动时会提示版本过低风险。
