...
<p align="center">
  ...
  <a href="https://github.com/jxxghp/MoviePilot"><img src="https://img.shields.io/badge/MoviePilot-v3.0.8-darkviolet?style=flat-square" alt="MoviePilot Backend Version"></a>
...
- **MoviePilot 版本**: 当前兼容基线为后端 `v3.0.8`，媒体业务按 MoviePilot Web `v3.0.8` 对齐。低于该版本不在兼容范围；App 启动时会提示版本过低风险。真实 `v3.0.8` 后端兼容巡检仍待完成。
