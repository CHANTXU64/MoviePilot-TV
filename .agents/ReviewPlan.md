...
| C018-C | 已闭环 | verify_a001_h 主审、review_a001_j 独立复核完成；无新编号，F-110/F-057…F-059/F-179/F-168/F-170传播闭合，F-061根在A段，F-163/F-165有反证；F-165 用户降级P3（2026-08-20） |
...
| I011 | 已闭环 | 集成及第三裁完成；F-061按默认稳定覆盖后端策略与软过滤承诺升P2，TorrentCard并入F-175且按下载主入口升P2；F-032/F-057…059/F-110/F-168/F-179/F-186传播闭合，同ID更新由I012/F-219裁决；F-168 用户跳过（2026-08-20）；F-175 用户跳过（2026-08-20） |
