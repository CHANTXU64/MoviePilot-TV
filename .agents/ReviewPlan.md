...
| I005 | 已闭环 | review_a001_h完成MediaPreloader整文件集成，verify_a001_h定向独立复核；F-221 P2，F-220并入F-115后驳回且F-115升P2；后续I013/G02/G03裁决将F-180/F-118/F-119升P2、F-184升条件P1，F-117维持P3；其余传播校准 |；F-180 已修复（2026-08-20，Logger+全局失败通知）
...
| I016 | 受限已闭环 | G01/G06完成等级裁决：F-106 P2、F-240 P2、F-089按当前后端401转确认P2；F-111/F-112 P2、F-242 P3且用户决定跳过（2026-09-16）、F-241未验证P3，F-208为P3且用户决定跳过（2026-09-15），其余传播不变。三代理均曾主审W020分段，严格零暴露缺口永久披露 |
...
- `I016 / System整文件`：G06完成最后等级裁决，F-089按当前后端401转确认P2；F-106/F-111/F-112/F-240 P2、F-242 P3且用户决定跳过（2026-09-16）、F-241未验证P3不变，F-208为P3且用户决定跳过（2026-09-15），受限集成闭环。严格零暴露票不可能取得并须永久披露。
