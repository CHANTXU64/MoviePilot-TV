...
| W013-C | 已闭环 | 主审、独立复核与review_a001_j第三裁决完成；长overview并入F-185，F-190已修复（2026-09-15）：季卡与详情Sheet共用SeasonDisplayFormatter，定向3/3、反向还原失败校验、恢复后3/3与Simulator clean build通过；width-only海报四态无法维持360×540登记F-191确认P3。无写操作owner；可访问关闭及实际海报形态维持运行盲点；两位复核代理既往源码暴露永久披露 |；F-185 用户跳过（2026-08-20）
...
| W015 | 已闭环 | 双审与G06完成；F-193跨服同号ID的原条件P1链已由`90b40b4`闭合，当前仅剩同profile operation/presentation竞争P2；F-194 P2，F-027 P1/CHK-005及F-008/F-121/F-185/F-191传播闭合；F-164 已修复（2026-09-15），旧系统实际渲染/焦点仍未单独验证；F-185 用户跳过（2026-08-20）；F-194 用户跳过（2026-08-20） |
...
- `W015 / 既有传播`：401续登后权限撤销仍重放写动作令F-027升级P1并补CHK-005；成功不发`.subscriptionDidUpdate`归F-008，旧错误归F-121，长文本归F-185，海报归F-191；F-164 已修复（2026-09-15），旧系统实际渲染/焦点仍未单独验证。
