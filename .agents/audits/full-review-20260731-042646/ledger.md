...
| W015 | `ForkSubscribeSheet.swift` 全文件 | L5 | verify_a001_h | 已闭环（既往源码暴露披露） | review_a001_j | 已闭环 | G06将F-193升条件P1，F-194 P2；F-027/CHK-005与F-008/F-121/F-185/F-191传播闭合，F-164 已修复（2026-09-15），旧系统实际渲染/焦点仍未单独验证 | G02 | 已闭环 |
